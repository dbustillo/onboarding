/*
  ...
  1. Changes
    ...
    - Add proper error handling for document uploads
...
CREATE OR REPLACE FUNCTION admin_insert_client_document_v3(
  p_client_id uuid,
...
GRANT EXECUTE ON FUNCTION admin_insert_client_document_v3 TO authenticated;