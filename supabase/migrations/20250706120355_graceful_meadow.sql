/*
  # Clean Database Setup for Client Onboarding Platform
...
DROP TRIGGER IF EXISTS handle_updated_at ON quote_submissions;
DROP TRIGGER IF EXISTS handle_updated_at ON onboarding_templates;
DROP TRIGGER IF EXISTS handle_updated_at ON client_onboarding;
DROP TRIGGER IF EXISTS handle_updated_at ON onboarding_tasks;
DROP TRIGGER IF EXISTS handle_updated_at ON google_drive_resources;
DROP TRIGGER IF EXISTS handle_updated_at ON contracts;
